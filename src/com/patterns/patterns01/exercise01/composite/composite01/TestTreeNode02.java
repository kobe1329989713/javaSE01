 ...
 *
 */
public class TestTreeNode02 {
    private TreeNode root = null;

    public TestTreeNode02(String name) {
    ...
    public static void main(String[] args) {
        // 设置 root
        TestTreeNode02 tree = new TestTreeNode02("A");
...
//        }
        ...
        // parent
//        nodeB.setParent(root1); // 为什么不能直接获取它的父node ,必须要设置下了。必须要设置下，数据库里面也是设置了的。
